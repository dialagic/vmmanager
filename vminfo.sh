...
function get_load() {
	...
	load_curr_5=$(cat /proc/loadavg | awk -F" " "{print \$2}") # Ovo zakomentirat ako se fejka
	#load_curr_5=7.00 # Ovdje harkodirat
...
function get_ram_usage() {
	...
	available_percentage=$(echo "scale=2; ${available}*100/${total}" | bc) # Ovo zakomentirat ako se fejka
	#available_percentage='5.6' # Ovdje harkodirat
